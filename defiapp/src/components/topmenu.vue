        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active nav-white"  aria-current="page" href="#"  >Vault</a>
              </li>
              <li class="nav-item">
            ...
            <div class="d-flex">
             <button class="nav-button"  ><span style="margin-right: 0; color: white; padding: 8px;">$1.1</span><img src="meta.png" height="20px" style="margin-top: 10px;margin-left: 0;" alt=""></button >
            <button class="nav-button"  ><img src="gass.png" height="20px" style="margin-top: 10px;margin-left: 0;" alt=""><span style="margin-right: 0; color: white; padding: 8px;">$1.1</span></button >
